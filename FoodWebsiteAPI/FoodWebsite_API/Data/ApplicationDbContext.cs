...
namespace FoodWebsite_API.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__UserFavo__3214EC07A1B2C3D4");

                entity.HasIndex(e => new { e.UserId, e.SpecialtyId }).IsUnique();
                entity.HasIndex(e => e.UserId, "IX_UserFavorites_UserId");
                entity.HasIndex(e => e.SpecialtyId, "IX_UserFavorites_SpecialtyId");

                entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())").IsRequired();
                ...
                entity.HasOne(e => e.Specialty)
                      ...
                      .OnDelete(DeleteBehavior.Cascade)
                      .HasConstraintName("FK_UserFavorites_Specialty");
            });
