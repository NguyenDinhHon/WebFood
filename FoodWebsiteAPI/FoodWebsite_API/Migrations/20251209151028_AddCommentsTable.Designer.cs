...
namespace FoodWebsite_API.Migrations
{
    ...
    [Migration("20251209151028_AddCommentsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodWebsite_API.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "SpecialtyId", "CreatedAt" }, "IX_Comments_SpecialtyId_CreatedAt")
            ...
            modelBuilder.Entity("FoodWebsite_API.Models.UserFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__UserFavo__3214EC07A1B2C3D4");

                    b.HasIndex("UserId", "SpecialtyId")
                        .IsUnique();

                    b.HasIndex(new[] { "SpecialtyId" }, "IX_UserFavorites_SpecialtyId");

                    b.HasIndex(new[] { "UserId" }, "IX_UserFavorites_UserId");
            ...
            modelBuilder.Entity("FoodWebsite_API.Models.Comment", b =>
                {
                    b.HasOne("FoodWebsite_API.Models.Comment", "ParentComment")
                        .WithMany("Replies")
