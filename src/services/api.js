...
export const Api = {
  ...
  averageRatingBySpecialty: (specialtyId) => fetchAPI(`/Ratings/specialty/${specialtyId}/stats`),
  submitRating: (payload) => fetchAPI('/Ratings/submit', { method: 'POST', body: JSON.stringify(payload) }, true),
